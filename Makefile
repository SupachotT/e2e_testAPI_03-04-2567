...
runTest_local_level_3:
	newman run level-3/collections/sck-shopping-mall-level-3.postman_collection.json -e level-3/environments/sck-shoping-mall-local.postman_environment.json -d level-3/data/data.json -r htmlextra